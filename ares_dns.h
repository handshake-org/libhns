...
#define DNS_HEADER_Z(h)                 (((h)[3] >> 6) & 0x1)
#define DNS_HEADER_AD(h)                (((h)[3] >> 5) & 0x1)
#define DNS_HEADER_CD(h)                (((h)[3] >> 4) & 0x1)
...
#define DNS_HEADER_SET_Z(h, v)        ((h)[3] |= (unsigned char)(((v) & 0x1) << 6))
#define DNS_HEADER_SET_AD(h, v)       ((h)[3] |= (unsigned char)(((v) & 0x1) << 5))
#define DNS_HEADER_SET_CD(h, v)       ((h)[3] |= (unsigned char)(((v) & 0x1) << 4))
