...
typedef enum {
  ...
  ARES_DATATYPE_SSHFP_REPLY,  /* struct ares_sshfp_reply */
  ARES_DATATYPE_DANE_REPLY,   /* struct ares_dane_reply */
  ARES_DATATYPE_OPENPGPKEY_REPLY, /* struct ares_openpgpkey_reply */
#if 0
...
struct ares_data {
  ...
  union {
    ...
    struct ares_openpgpkey_reply   openpgpkey_reply;
  } data;
};
