...
*/
	...
	.align	2
	.global hns_secp256k1_fe_mul_inner
	.type	hns_secp256k1_fe_mul_inner, %function
	@ Arguments:
...
hns_secp256k1_fe_mul_inner:
	...
	*/
	...
	.size	hns_secp256k1_fe_mul_inner, .-hns_secp256k1_fe_mul_inner

	.align	2
	.global hns_secp256k1_fe_sqr_inner
	.type	hns_secp256k1_fe_sqr_inner, %function
	@ Arguments:
...
hns_secp256k1_fe_sqr_inner:
	...
	*/
	...
	add	sp, sp, #48
	ldmfd	sp!, {r4, r5, r6, r7, r8, r9, r10, r11, pc}
	.size	hns_secp256k1_fe_sqr_inner, .-hns_secp256k1_fe_sqr_inner
